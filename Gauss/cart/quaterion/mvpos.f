	...
	integer i,seed,N,nc,nci(10),pos,l
...
!	print *,"do coordinate transformation to",pos,"th cluster"
	print *,"do coordinate transformation to",l,"th cluster"
	call random_number(r)
!	r1=r
!	if (r1.lt.0.5) then
...
!	call random_number(r)
	do 20 i=nci(l),nci(l+1)-1
	y(i)=y(i)+(r-0.5)*1.0
20	continue
!	else
!	print *,"do z direction translation"
	call random_number(r)
	do 30 i=nci(l),nci(l+1)-1
	z(i)=z(i)+(r-0.5)*1.0
30	continue
!	endif
!	else
...
50	continue
	! do actuall rotation
	call random_number(r)
	theta=(r-0.5)*2.0*pi  !random rotation angle
